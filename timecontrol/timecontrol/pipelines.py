...
class MongoPipeline(object):
    def __init__(self, mongo_db, mongo_collection, id_field):
    ...
    def process_item(self, item, spider):
        uid = item[self.id_field]

        #override update
        self.db[self.mongo_collection].replace_one({self.id_field:uid},item,upsert=True)
